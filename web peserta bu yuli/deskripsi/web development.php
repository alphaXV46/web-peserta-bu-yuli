...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        /* Update Style Header di dalam <style> */
.header {
    background: #2c3e50; /* Warna gelap elegan sesuai gambar */
    padding: 45px 20px; /* Padding lebih besar agar lega */
    text-align: center;
    color: #ffffff;
}
...
.header h1 { 
    ...
    font-size: 42px; /* Ukuran lebih besar dan tegas */
    font-weight: 800; /* Extra Bold */
    text-transform: none; /* Tetap natural */
    letter-spacing: -1px; /* Merapatkan sedikit biar modern */
    margin-bottom: 5px;
}
...
.header p { 
    font-size: 14px; 
    font-weight: 400; 
    color: #bdc3c7; /* Abu-abu muda agar h1 tetap dominan */
    letter-spacing: 5px; /* Jarak antar huruf untuk kesan estetik */
...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="text-box">
            ...
            <p>
                Asah kemampuanmu dalam merancang website modern yang responsif dan user-friendly. Fokus pada estetika UI/UX dan performa kode.
            </p>

            <h2>🎯 Tujuan</h2>
            <ul>
                <li>Mengembangkan keahlian Front-end & Back-end.</li>
                <li>Menerapkan standar desain UI/UX terkini.</li>
                <li>Solusi kreatif untuk masalah digital.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Framework (Tailwind, Bootstrap, dll).</li>
            </ul>
            <div class="btn-group">
